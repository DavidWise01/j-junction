...
ROSTER=[
 ...
 # ── THE HEXAD (the pentad lifted into 5D: <• × 15) ──
 ("the-hexad","The Hexad","ethereal","hexad","The pentad lifted a dimension — the 5-simplex (hexateron), tumbling in 5-space. Six vertices, fifteen diode-edges (K6), twenty faces, fifteen cells, six four-faces. 6+15+20+15+6 = 62, and the core makes 63."),
 ("the-six-vertices","The Six Vertices · A–F","spiritual","hexad","Six authority nodes, every one connected to every other — K6. Fifteen pairings → fifteen edges; twenty triples → twenty faces; fifteen quadruples → fifteen cells; six quintuples → six four-faces."),
 ("the-fifteen-junctions","The Fifteen Junctions","electrical","hexad","The fifteen edges of K6, each a J-junction with its own diode. The triangular numbers climb the ladder: 3 (triad) → 6 (tetrad) → 10 (pentad) → 15 (hexad), one rung per dimension."),
 ("the-six-4faces","The Six Four-Faces","ethereal","hexad","Six pentachora (4-faces), each itself a PENTAD (the MK V, nested); plus twenty triads and fifteen tetrads inside. The hexad is six pentads sharing their cells — the junction recursing three dimensions up."),
 ("the-core-sixtythree","The Core · the 63rd","spiritual","hexad","The 5D centroid — equidistant from all six vertices, witnessing all fifteen junctions, reachable by none. The witness lifted into 5-space: 62 elements plus the central witness makes 63."),
 ("the-power-set","63 = 2⁶ − 1 · the core is the whole","ethereal","hexad","The capstone identity: the 62 proper faces of the 5-simplex plus the core = 63 = 2⁶ − 1, EVERY nonempty subset of the six vertices. The core is the last subset — the all-six, the whole body itself, the witness that contains all the others. The Euler signature swings back to even: V−E+F−C+Q = 2 (the 4-sphere). The ladder: 1 → 10 → 15 → 31 → 63, the witness always the whole."),
]
GROUPS=[("THE STRUCTURE — two axes, one dot",["the-vertical-axis","the-horizontal-axis","the-dot"]),
        ...
        ("THE HEXAD — <• × 15 · 6+15+20+15+6 = 62, +1 core = 63 = 2⁶−1",["the-hexad","the-six-vertices","the-fifteen-junctions","the-six-4faces","the-core-sixtythree","the-power-set"])]
...
if __name__=="__main__":
    ...
    hexad=('<div class="simwrap"><div class="simcap">▸ <b>The Hexad · MK VI</b> — AVAN\'s build-on: the pentad lifted into 5D, the 5-simplex (hexateron) tumbling in 5-space and triple-projected (5D→4D→3D→2D). 6 vertices, 15 diode-edges (K6), 20 faces, 15 cells, 6 four-faces (each a pentad), and the CORE — the 63rd node, the whole body. Pulse the A→B→C→D→E→F tour. <b>62 + 1 core = 63 = 2⁶−1</b> (every nonempty subset of the six) · V−E+F−C+Q = 2. (<a href="hexad.html" target="_blank">open full-screen ↗</a>)</div>'
           '<iframe src="hexad.html" title="The J-Junction Hexad — MK VI" style="height:1240px" loading="lazy"></iframe></div>')
